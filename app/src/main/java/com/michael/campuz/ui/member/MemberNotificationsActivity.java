...
public class MemberNotificationsActivity extends AppCompatActivity {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.navigation_discussion: {
                                Intent intent = new Intent(MemberNotificationsActivity.this, MemberDiscussionActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
                                break;
                            }
                            case R.id.navigation_study_group: {
                                Intent intent = new Intent(MemberNotificationsActivity.this, MemberStudyGroupActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
                                break;
                            }
                            case R.id.navigation_resources: {
                                Intent intent = new Intent(MemberNotificationsActivity.this, MemberResourcesActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
                                break;
                            }
